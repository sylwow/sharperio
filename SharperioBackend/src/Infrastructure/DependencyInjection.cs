...
using SharperioBackend.Infrastructure.Files;
using SharperioBackend.Infrastructure.Persistence;
using SharperioBackend.Infrastructure.Services;
...
namespace SharperioBackend.Infrastructure;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        if (configuration.GetValue<bool>("UseInMemoryDatabase"))
        {
            ...
            {
                options.UseInMemoryDatabase("SharperioBackendDb");
            });
        }
        else
        {
